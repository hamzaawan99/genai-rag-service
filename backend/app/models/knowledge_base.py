...
class KnowledgeBase(Base):
    ...
    vector_db = Column(String, nullable=False, default="chromadb")  # chromadb or weaviate
    collection_name = Column(String, unique=True, nullable=False)  # Collection/Class name in vector DB
